...
export const getProduct =
  (keyword = "", currentPage = 1, price = [0, 125000], category,subCategory, ratings = 0,sort) =>
  async (dispatch) => {
    try {
     ...
     if(data){
      if(sort === 'latest'){
        ...
        data?.products.sort((a,b) => (a.ratings - b.ratings))
...
//all featured products --admin
export const getFeaturedProduct = () => async (dispatch) => {
  try {
    dispatch({ type: ALL_FEATURED_PRODUCTS_REQUEST })
